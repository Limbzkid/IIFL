											...
											<div class="accordionContent docUploadBox">
												...
												<div class="detailwrap-line1">
													...
													<div class="detailfields detailfields-veri marright-field bnkAcct dnone">
														<label class="input"><span class="account">Account Number</span><input type="text" id="account" maxlength="16"/></label>
													</div>
													<div class="clr"></div>													
												</div>
											</div>
											...
											<div class="accordionContent docUploadBox wpv">
												...
												<div class="detailwrap-line1">
													<div class="detailfields detailfields-veri marrightnone">
														<label class="input"><span class="pin">Pincode*</span><input type="text" id="pincode" maxlength="6"/></label>
													</div>
													<div class="detailfields detailfields-veri marrightnone">
													...
													<div class="veryfymail-box marrightnone">
														...
														<div class="verifymail-field">
															<label class="input"><span>Work email id</span><input type="text" id="email" maxlength="50"/></label>
														</div>
														<!--<div class="verifybtn">
