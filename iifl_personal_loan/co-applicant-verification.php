...
<div id="msform">
  ...
  <div>Current EMI <strong class="strong-inner"> <span class="rsmonthly rstotalemi">`</span>
    ...
    <div class="approval-wrap align-left CoVerify">
  ...
  <div class="approval-right-container width100">
              ...
              <div class="clr"></div>
							<form action="co-applicant-verification" method="post">
								<div class="verifymainsubmit uploadsubmit">
									...
									<a href="<?php echo HOME; ?>/co-applicant-upload-financial-document" class="homesubmit"> Add Another Bank</a>
								</div>
							</form>
