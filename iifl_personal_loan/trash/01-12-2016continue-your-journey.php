 ...
 <!--popup-->
  ...
  <div class="innerbody-home for-mob-height height-ipad-812 full-height" style="height:auto;"> 
    <div class="approval-wrap">
      <div class="approval-right-container centerpanel">
  <div class="aadhar-wrap">
    <div class="aadhar-heading aadhar-heading-font">CONTINUE YOUR JOURNEY<sup><span class="red1">*</span></sup>. <br>
      </div>
    ...
    <!-- <span style="color:#D44242">eKYC services will not be available till 11th Nov 2016</span> <br></br> -->
      <label class="input"><span>CRM LEAD ID</span>
        <input type="text" id="crmidplace" name="crmidplace" />
										<input type="hidden" id="theOtp" value=""/>
      </label>
    </div>
    <div class="aadharbtn">
      <input type="button" id="crmid" value="GO" class="aadharsubmit" name="crmid" >
    </div>
    <div class="companyname sceeen4form fl centerpanel">
    ...
    <div class="aadhar-tcbox authentication-line" style="display:none">
