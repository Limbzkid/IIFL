...
<?php session_start(); ?>
<?php
	//echo '<div class="dnone"> <pre>'; print_r($_SESSION); echo '</pre></div>';
	$residence_list = '';
	...
	curl_close($ch);
	//echo '<div class="dnone"><pre>'; print_r($curl_response); echo '</pre></div>';
	...
	if(isset($_POST['aipSubmit'])) {
		...
		if(!preg_match("/[0-9]/", $_POST['residencestability'])) {
			...
			$residence_stability = $_SESSION['personal_details']['residencestability'] = xss_filter($residence_stability);
		}
		...
		if(!$error) {
			...
			$decodeddata = json_encode($curl_post_data);
			//echo '<div class="dnone"><pre>Request --- <br/>'; print_r($decodeddata); echo '</pre></div>';
			...
			//echo '<div class="dnone"><pre>Response --- <br/>'; print_r($curl_response); echo '</pre></div>';
...
<!--<![endif]-->
	...
	$( "#SliderPoint4").draggable({ containment: "parent", axis: "x", drag: function(event, ui){PointerFN(event.target.id,"years",1,5,' Years');}});
				...
				setPoint('period','SliderPoint5',1,<?php echo $loan_tenure?>,'');
			
				clickbar("SliderPoint3","loan",0,1000000,"");
				clickbar("SliderPoint4","years",0,<?php echo $loan_tenure?>," Years");
				clickbar("SliderPoint5","period",0,<?php echo $loan_tenure?>," ");
  ...
  <div id="updatehide">
								<div class="loan-detailbox">
									...
									<div class="total-emi">EMI - <span class="orange"><b class="rupee-symb">`</b> <b id="emidiv"><?php echo to_rupee($_SESSION['personal_details']['appliedloanamt']); ?></b></span></div> 
  ...
  <div class="clr"></div>
    ...
    <div class="approval-right-container">
      ...
      <div class="detailwrap-line1">
        ...
        <input type="hidden" name="residencestability" value="2" id="period"/>
      ...
      <div class="personalinfo-radiobox">
										...
										<div class="next-home next-scr2 tc">
											...
											<input type="submit" name="aipSubmit" id="buttonElg" disabled="true" value="CHECK ELIGIBILITY" class="homesubmit disabled" />
        </div>
      </div>
    <div class="clr"></div>
  </div>
