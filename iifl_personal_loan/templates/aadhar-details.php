...
<div id="main-wrap">
	<!-- AAdhar page pixel-->
	<img src="http://pixel.everesttech.net/px2/784?px_evt=t&ev_Aadhar-Card=<Aadhar-Card>&ev_transid=<?php echo $_SESSION['personal_details']['CRMLeadID']; ?>" width="1" height="1"/>
  ...
  <div class="loan-amount">Loan Amount -
								<span class="orange"><b class="rupee-symb">`</b> <b id="loanAmu"><?php echo to_rupee($loan_amount); ?></b></span>
								<br>
    Loan Tenure -
  ...
  <div class="total-emi">EMI -
								<span class="orange">
									...
									<b id="emidiv"><?php echo to_rupee($emi); ?></b>
								</span>
							</div>
  ...
  <div class="aadhar-wrap">
    ...
    <div class="companyname sceeen4form dnone">
      <label class="input"> <span>Enter OTP</span>
        <input type="text" id="OTP" onkeypress="return isNumberKey(event)"/>
      </label>
    </div>
