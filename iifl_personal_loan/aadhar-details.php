...
<?php
	...
	if($_POST['emiVal'] == '') {
		...
		if(!is_numeric(num_only($_POST['emiVal']))) {
			...
			$emi = $_SESSION['personal_details']['actualloanEMI'] = calculate_emi($loan_amount, $_POST['roiAct'], $tenure);
		}
	}
  ...
  if(!is_numeric(num_only($_POST['webpageno']))) 
  {
      $error = true;
  } 
  else 
  {
      //$emi = $_SESSION['personal_details']['webpageno'] = num_only($_POST['webpageno']);
  }
    }
        ...
        <div class="innerbody-home for-mob-height height-ipad-812 full-height" style="height:auto;">
          <div class="eligibleDetail">
            <div class="edTop">
              ...
              <div>Monthly Salary<strong class="strong-inner"> <span class="rsmonthly">`</span><?php echo to_rupee($salary); ?></strong> </div>
              <div>Current EMI <strong class="strong-inner"><span class="rsmonthly rstotalemi">`</span><?php echo to_rupee($obligation); ?></strong> </div>
            </div>
            <div class="clr"></div>
          </div>
          <div id="updatehide">
            <div class="loan-detailbox">
              ...
              <div class="loan-amount">Loan Amount - <span class="orange"><span class="disp-in-block"><b class="rupee-symb">`</b> <b id="loanAmu"><?php echo to_rupee($loan_amount); ?></b></span></span> <br>
                Loan Tenure - <span class="orange" id="tenure"><?php echo $loan_tenure; ?> Years</span> </div>
              <div class="loan-amount loanamout-small">Rate of Interest - <span class="orange"><?php echo $_SESSION['personal_details']['roi_actual']; ?>%</span> <br>
                Processing Fees -&nbsp;<span class="orange"><span class="disp-in-block"><b class="rupee-symb">`</b> <?php echo to_rupee($processing_fee); ?></span></span> </div>
              <div class="total-emi">
								EMI -
								<span class="orange">
									<span class="disp-in-block">
          ...
          <div class="approval-wrap">
            ...
            <div class="approval-right-container">
              <div class="aadhar-wrap">
                ...
                <div class="aadharbtn">
                  <input type="hidden" name="webpageno" id="webpagenogetotp" value="3" />
                ...
                <div class="aadharbtn dnone">
                  <input type="hidden" name="webpageno" id="webpagenoverifyotp" value="3" />
                  ...
                  <a href="javascript:;" class="text-link resendOtp"> Resend OTP</a> </div>
                ...
                <div class="aadharbtn">
                  <input type="hidden" name="webpageno" id="webpagenonoaadhar" value="3" />
